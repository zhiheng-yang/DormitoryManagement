<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs" Inherits="DormitoryManagement.login" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
		...
		<title>登录界面</title>
		<link href="~/res/js/index_data/default.css" rel="stylesheet" type="text/css">
		<!--必要样式-->
		<link href="~/res/js/index_data/styles.css" rel="stylesheet" type="text/css">
		<link href="~/res/js/index_data/demo.css" rel="stylesheet" type="text/css">
		<link href="~/res/js/index_data/loaders.css" rel="stylesheet" type="text/css">
</head>
    
	<body style="background: rgba(0, 0, 0, 0) url(&quot;data:image/png;base64,&quot;) repeat scroll 0% 0%;">
        ...
        <div class="login">
			...
			<div class="login_fields">
				...
				<div class="login_fields__submit">
                        ...
                        <asp:Button ID="Button1" runat="server" Text="登录" οnclick="Button1_Click" OnClick="Button1_Click" />
		...
		<link href="index_data/layui.css" rel="stylesheet" type="text/css">
		
		<script type="text/javascript" src="index_data/jquery_002.js"></script>
		<script type="text/javascript" src="index_data/jquery-ui.js"></script>
		<script type="text/javascript" src="index_data/stopExecutionOnTimeout.js"></script>
		<script type="text/javascript" src="index_data/layui.js"></script>
		<script type="text/javascript" src="index_data/Particleground.js"></script>
		<script type="text/javascript" src="index_data/Treatment.html"></script>
            ...
            layui.use('layer', function () {
                ...
                $('input[type="button"]').click(function () {
                    ...
                    //}
                        ...
                        console.log(111);
                        alert("登录成功");
                        //window.location.href = 'http://49.234.112.12:8081/jQueryLogin/index.html?';
                        //});						
                    }
                })
            })
		...
		<script type="text/javascript" src="index_data/ThreeWebGL.js"></script>
		<script type="text/javascript" src="index_data/ThreeExtras.js"></script>
		<script type="text/javascript" src="index_data/Detector.js"></script>
		<script type="text/javascript" src="index_data/RequestAnimationFrame.js"></script>
        ...
        </script><div><canvas width="1536" height="674"></canvas></div>
